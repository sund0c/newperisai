...
class ReportReceivedNotification extends Notification implements ShouldQueue
{
    ...
    public function toMail(object $notifiable): MailMessage
    {
        return (new MailMessage)
            ...
            ->line('**Deskripsi Singkat:** ' . ($this->report->description ?? '-'))
            ->line('**Tingkat Dampak berdasarkan PoC:** ' . (\App\Models\Report::severityLabel()[$this->report->severity_reporter] ?? $this->report->severity_reporter))
