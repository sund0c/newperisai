...
{
    // ID dari tabel klasifikasi_asets dan sub_klasifikasi_asets
    // yang sudah ada di database Pemprov Bali
    const ID_PL          = 'a1b93053-cc1a-4612-8ed0-9a544388bbc5'; // Perangkat Lunak
    const ID_PL_WEB      = 'a1b8ffb3-40fb-48d5-8bec-aad7047294c7'; // Aplikasi berbasis Website
    const ID_PL_MOB      = 'a1b93053-d042-4c47-93a0-09463c537c03'; // Aplikasi berbasis Mobile
    const ID_PL_DSK      = 'a1b93053-d143-4772-be2a-9870b32e4678'; // Aplikasi berbasis Desktop
    const ID_PL_OS       = 'a1b93053-cfa4-46af-84a4-d4ee89be1390'; // Sistem Operasi
    const ID_PL_UTL      = 'a1b93053-cfd2-46f8-8219-61bbb06f37fc'; // Sistem Utility

    public function run(): void
    {
        // =====================================================================
        // GLOBAL PERANGKAT LUNAK
        // Berlaku untuk semua sub-kelas PL
        // =====================================================================
        ...
        // =====================================================================
        // SPESIFIK: APLIKASI BERBASIS WEBSITE
        // =====================================================================
        $setId = $this->createSet(
            'subclass',
            self::ID_PL_WEB,
        ...
        // =====================================================================
        // SPESIFIK: APLIKASI BERBASIS MOBILE
        // =====================================================================
        $setId = $this->createSet(
            'subclass',
            self::ID_PL_MOB,
        ...
        // =====================================================================
        // SPESIFIK: APLIKASI BERBASIS DESKTOP
        // =====================================================================
        $setId = $this->createSet(
            'subclass',
            self::ID_PL_DSK,
