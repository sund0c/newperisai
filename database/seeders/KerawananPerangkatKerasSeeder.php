...
{
    const ID_PK      = 'a1b93053-cc54-4f84-97e6-ad22898dccdb'; // Perangkat Keras
    const ID_PK_PC   = 'a1b93053-ceb8-4f62-9778-ab2092328488'; // PC/Laptop/Smartphone
    const ID_PK_SRV  = 'a1b93053-cef0-4309-ab32-4e872cbb6c14'; // Server
    const ID_PK_NET  = 'a1b93053-cf1f-4469-97a4-02e838c931c5'; // Perangkat Jaringan
    const ID_PK_STR  = 'a1b93053-cf70-4ef0-9744-84e2e7d3444f'; // Perangkat Penyimpanan
    ...
    public function run(): void
    {
        ...
        $setId = $this->createSet(
            ...
            self::ID_PK_NET,
            '1.0',
            'Versi awal — kerawanan tambahan spesifik Perangkat Jaringan (Network Device).'
        );
        ...
        // =====================================================================
        // SPESIFIK: PERANGKAT PENYIMPANAN (STORAGE DEVICE)
        // =====================================================================
        $setId = $this->createSet(
            'subclass',
            self::ID_PK_STR,
            '1.0',
            'Versi awal — kerawanan tambahan spesifik Perangkat Penyimpanan (Storage Device).'
        );
