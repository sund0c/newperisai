...
{
    const ID_SP     = 'a1b93053-cc88-4fd6-82f5-1f0351cb3a25';
    const ID_SP_APP = 'a1b93053-d070-436b-9cd1-8a5504bf8133';
    const ID_SP_FAC = 'a1b93053-d0a0-4b33-9a1d-309d9d49d718';
    ...
    public function run(): void
    {
        ...
        $this->insertItems($setId, [
            [
                ...
                'dampak_tipikal'   => 'Operasional organisasi terhenti dalam waktu yang tidak pasti; pemulihan berjalan lambat; kerugian layanan kepada masyarakat',
                'area_dampak'      => ['Layanan Organisasi', 'Kinerja', 'Operasional TIK'],
                'kontrol_tipikal'  => 'Penanganan gangguan dilakukan secara reaktif berdasarkan pengalaman dan inisiatif individu tanpa panduan tertulis',
                'mitigasi_tipikal' => 'Susun dan dokumentasikan rencana keberlangsungan operasional; uji rencana secara berkala; pastikan seluruh personel kunci memahami perannya',
            ],
            [
                'nomor_urut'       => 2,
                ...
                'kategori'         => 'Terganggunya Keberlangsungan Layanan',
                'dampak_tipikal'   => 'Kerusakan mendadak menghentikan operasional tanpa persiapan; biaya perbaikan darurat jauh lebih tinggi; pemulihan membutuhkan waktu lebih lama',
                'area_dampak'      => ['Operasional TIK', 'Kinerja', 'Finansial'],
                'kontrol_tipikal'  => 'Pemeliharaan hanya dilakukan saat sudah terjadi kerusakan atau keluhan; tidak ada jadwal pemeliharaan preventif',
                'mitigasi_tipikal' => 'Terapkan program pemeliharaan preventif dengan jadwal yang terstruktur; dokumentasikan kondisi sarana pendukung dan riwayat pemeliharaan; prioritaskan berdasarkan tingkat kekritisan',
            ],
            [
                'nomor_urut'       => 3,
                ...
                'kontrol_tipikal'  => 'Akses ke area kritis dibatasi hanya dengan kunci fisik konvensional tanpa pencatatan',
            ...
            [
                ...
                'kategori'         => 'Keamanan Infrastruktur',
                'dampak_tipikal'   => 'Sarana pendukung rusak atau hilang; operasional terganggu; biaya penggantian yang tinggi',
                'area_dampak'      => ['Operasional TIK', 'Kinerja', 'Finansial'],
                'kontrol_tipikal'  => 'Keamanan fisik bergantung pada petugas keamanan dan kunci pintu tanpa prosedur terstandar',
                'mitigasi_tipikal' => 'Tetapkan prosedur keamanan fisik yang terstandar; pastikan prosedur diterapkan secara konsisten; lakukan audit keamanan fisik secara berkala',
            ],
        ]);
        ...
        $this->insertItems($setId, [
            [
                ...
                'ancaman_tipikal'  => 'Pemadaman listrik dari penyedia eksternal, lonjakan arus dari luar, atau bencana yang merusak infrastruktur listrik menghentikan seluruh perangkat',
                'kategori'         => 'Terganggunya Keberlangsungan Layanan',
                'dampak_tipikal'   => 'Seluruh sistem dan layanan yang menggunakan perangkat terkait terhenti secara mendadak; data yang sedang diproses berisiko rusak',
                'area_dampak'      => ['Operasional TIK', 'Layanan Organisasi', 'Kinerja'],
                'kontrol_tipikal'  => 'Perangkat kritikal hanya menggunakan sumber listrik utama tanpa cadangan',
                'mitigasi_tipikal' => 'Pasang sumber daya cadangan untuk perangkat kritikal; pastikan kapasitas cadangan cukup untuk waktu penanganan darurat yang memadai; uji sistem cadangan secara berkala',
            ],
            [
                'nomor_urut'       => 2,
                ...
                'ancaman_tipikal'  => 'Kerusakan mendadak pada unit pendingin — akibat pemadaman, gangguan mekanis, atau kondisi lingkungan ekstrem — menyebabkan suhu ruangan melonjak di luar kendali',
                'kategori'         => 'Terganggunya Keberlangsungan Layanan',
                ...
                'area_dampak'      => ['Operasional TIK', 'Kinerja', 'Finansial'],
                'kontrol_tipikal'  => 'Hanya terdapat satu unit sistem pendingin untuk setiap ruang perangkat tanpa unit cadangan',
                'mitigasi_tipikal' => 'Pasang sistem pendingin dengan redundansi; pastikan sistem cadangan dapat diaktifkan secara otomatis saat sistem utama gagal; pantau suhu ruangan secara terus-menerus',
            ],
            [
                'nomor_urut'       => 3,
                ...
                'ancaman_tipikal'  => 'Penyedia layanan internet mengalami gangguan operasional, melakukan pemeliharaan tanpa pemberitahuan, atau terdampak bencana sehingga koneksi terputus sepenuhnya',
                'kategori'         => 'Terganggunya Keberlangsungan Layanan',
                ...
                'area_dampak'      => ['Layanan Organisasi', 'Operasional TIK', 'Kinerja'],
        ...
        $this->insertItems($setId, [
            [
                ...
                'ancaman_tipikal'  => 'Kebakaran, banjir, suhu ekstrem, atau bencana lain yang berasal dari luar ruangan perangkat merusak seluruh perangkat di dalamnya',
                'kategori'         => 'Terganggunya Keberlangsungan Layanan',
                'dampak_tipikal'   => 'Perangkat mengalami kerusakan permanen; seluruh layanan terhenti; pemulihan membutuhkan waktu dan biaya yang signifikan',
                'area_dampak'      => ['Operasional TIK', 'Layanan Organisasi', 'Finansial', 'Kinerja'],
                'kontrol_tipikal'  => 'Pendingin ruangan standar digunakan tanpa pemantauan suhu terus-menerus; tidak ada sistem deteksi kebakaran khusus',
                'mitigasi_tipikal' => 'Pasang sistem kontrol lingkungan dengan pemantauan otomatis dan peringatan dini; pastikan sistem pendingin memiliki redundansi; pasang sistem deteksi dan pemadam kebakaran; uji sistem secara berkala',
            ],
            [
                'nomor_urut'       => 2,
                ...
                'kategori'         => 'Keamanan Infrastruktur',
                'dampak_tipikal'   => 'Informasi sensitif terekspos kepada pihak yang tidak berwenang; perangkat di area terbatas dapat diakses atau dimanipulasi',
            ...
            [
                ...
                'kategori'         => 'Keamanan Infrastruktur',
                'dampak_tipikal'   => 'Insiden fisik tidak terdeteksi tepat waktu; investigasi tidak dapat dilakukan karena tidak ada bukti rekaman',
                ...
                'mitigasi_tipikal' => 'Pasang sistem kamera pengawas di seluruh area kritis; pastikan rekaman disimpan dan terlindungi untuk periode yang memadai; tinjau rekaman secara berkala',
            ],
            [
                'nomor_urut'       => 4,
                'deskripsi'        => 'Instalasi kabel dan infrastruktur jaringan tidak terlindungi secara fisik sehingga dapat diakses, dirusak, atau disadap secara fisik',
                ...
                'area_dampak'      => ['Operasional TIK', 'Layanan Organisasi'],
                'kontrol_tipikal'  => 'Kabel jaringan terpasang tanpa pelindung fisik yang memadai; jalur kabel dapat diakses di berbagai titik',
                'mitigasi_tipikal' => 'Lindungi instalasi kabel dengan pelindung fisik yang memadai; pasang kabel di jalur yang tidak mudah diakses; dokumentasikan seluruh jalur kabel; periksa instalasi secara berkala',
            ],
        ]);
    }
