...
return new class extends Migration {
    ...
    {
        Schema::create('dpo_activity_logs', function (Blueprint $table) {
            $table->id();

            $table->foreignId('dpo_process_id')
                ->constrained('dpo_processes')
                ->cascadeOnDelete();
            ...
            $table->index('dpo_process_id');
        });
    }

    public function down(): void
    {
        Schema::dropIfExists('dpo_activity_logs');
    }
};
