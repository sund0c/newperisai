...
@section('title', 'Tiket Mitigasi')
@section('page-title', 'Tiket Mitigasi')
@section('page-subtitle', 'Daftar laporan valid yang memerlukan tindakan mitigasi')

@section('content')

    {{-- Filter & Search --}}
    <div class="mb-4 flex flex-wrap items-center gap-3">
        <form method="GET" action="{{ route('csirt.reports.index') }}" class="flex flex-wrap items-center gap-2 flex-1">
            ...
            <select name="status"
                ...
                @foreach (\App\Models\CsirtProcess::statusLabel() as $value => $label)
    ...
    @if ($processes->isEmpty())
        <div class="bg-white rounded-xl border border-gray-200 p-12 text-center">
            ...
            <p class="text-gray-500 text-sm">Tidak ada tiket mitigasi yang ditemukan.</p>
        </div>
    @else
