                ...
                <div class="space-y-4">
                    <div class="grid grid-cols-1 gap-4">
                        ...
                        <div>
                            ...
                            <p class="mt-1 text-xs text-gray-400">Min. 8 karakter, huruf besar/kecil, angka, dan simbol (!@#$%)</p>
                        </div>
                        <div>
                    ...
                    <div class="flex items-start gap-2 mt-2">
                        ...
                        <label for="terms" class="text-sm text-gray-600">
                            ...
                            Data akan digunakan sesuai <a href="#" class="text-blue-600 underline">kebijakan privasi</a> CSIRT Bali.
                        </label>
                    </div>
