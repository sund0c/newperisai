...
<body
    ...
    <div class="w-full max-w-md">
        <div class="text-center mb-6">
            <img src="{{ asset('images/logo.png') }}" alt="CSIRT Bali" class="h-16 w-auto object-contain mx-auto mb-4">
        ...
        <div class="bg-white rounded-2xl shadow-2xl p-8">
            ...
            @if ($isForced)
                <div class="mb-4 p-3 bg-blue-50 border border-blue-200 rounded-lg text-sm text-blue-700">
                    Password Anda wajib diganti sebelum melanjutkan.
                </div>
            @else
                <div class="mb-4 p-3 bg-yellow-50 border border-yellow-200 rounded-lg text-sm text-yellow-700">
                    Password Anda akan kedaluwarsa pada <strong>{{ $expiresAt }}</strong>
                    ({{ $daysLeft }} hari lagi).
                </div>
            @endif
