    ...
    <div class="lg:pl-64 flex flex-col min-h-full">
        ...
        <header class="sticky top-0 z-30 flex items-center justify-between h-16 px-4 bg-white border-b border-gray-200 shadow-sm">
            ...
            <div class="flex items-center gap-2 ml-auto">
                ...
                @else
                <span class="flex items-center gap-1 text-xs text-green-600 bg-green-50 px-2.5 py-1 rounded-full border border-green-200">
        ...
        <div class="px-6 pt-4">
            @if(session('success'))
            <div class="flex items-center gap-2 p-4 mb-4 text-sm text-green-800 bg-green-50 border border-green-200 rounded-lg">
