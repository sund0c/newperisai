...
<div class="max-w-2xl">
        ...
        <form method="POST" action="{{ route('support.users.store') }}">
            ...
            <div class="space-y-4">
                ...
                <div class="p-3 bg-amber-50 border border-amber-200 rounded-lg text-xs text-amber-700">
                    <strong>Informasi Password:</strong> Password awal user dibangkitkan secara otomatis.
                    User akan diwajibkan mengganti password saat login pertama.
                    Notifikasi email akan dikirimkan otomatis ke alamat email di atas.
                </div>
    ...
    <div class="mt-6 bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        ...
        <form method="POST"
              action="{{ route('support.users.certificate', $createdUser) }}"
