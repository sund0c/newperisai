        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-5">
            ...
            <div class="space-y-3 text-sm">
                ...
                <div>
                    ...
                    @else
                    <span class="inline-flex px-2 py-0.5 rounded-full text-xs font-medium bg-red-100 text-red-700">Nonaktif</span>
                    @endif
                </div>
            </div>
        </div>
                ...
                <div class="flex items-center justify-between px-5 py-3.5 hover:bg-gray-50">
                    <div class="min-w-0">
                        <div class="flex items-center gap-2">
                            ...
                            <span class="inline-flex px-1.5 py-0.5 rounded text-xs font-medium bg-amber-100 text-amber-700">
                                Historis
                            </span>
                            @endif
                        </div>
