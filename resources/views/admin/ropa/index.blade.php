        ...
        <table class="min-w-full divide-y divide-gray-200 text-sm">
            <thead class="bg-gray-50">
                <tr>
                    ...
                    <th class="px-3 py-3 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider w-36">Kode
                    </th>
            ...
            <tbody class="divide-y divide-gray-100">
                @forelse ($activities as $activity)
                    <tr class="hover:bg-gray-50 transition-colors">
                        ...
                        <td class="px-6 py-3">
                            <span class="text-xs text-gray-600">{{ $activity->opd?->namaopd ?? '-' }}</span>
                        </td>
                        <td class="px-6 py-3">
