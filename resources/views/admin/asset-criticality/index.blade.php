        ...
        <table class="min-w-full divide-y divide-gray-200 text-sm">
            <thead class="bg-gray-50">
                <tr>
                    ...
                    <th class="px-6 py-3 text-left text-xs font-semibold uppercase tracking-wide text-gray-500">Klas / Sub
                        Klas</th>
                    ...
                    <div class="p-5 space-y-3">
                        ...
                        @foreach ($ciaOptions['C'] as $opt)
                            <label
                                ...
                                data-group="bulk_confidentiality" data-value="{{ $opt['value'] }}" data-color="purple">
                                <input type="radio" name="confidentiality" value="{{ $opt['value'] }}"
                                    class="mt-0.5 h-4 w-4 flex-shrink-0 text-purple-600 border-gray-300"
                    ...
                    <div>
                        <div id="bulkPreviewWrap" class="hidden flex items-center gap-2">
                            ...
                            <span id="bulkPreviewBadge"
                                class="inline-flex items-center rounded-full px-3 py-1 text-sm font-bold"></span>
                            <span class="text-xs text-gray-400">= max(C, I, A) · diterapkan ke semua aset terpilih</span>
                        </div>
                        <p id="bulkPreviewHint" class="text-xs text-gray-400 italic">Pilih nilai C, I, dan A untuk preview
                            kritikalitas</p>
                    </div>
                    <div class="flex gap-3 flex-shrink-0">
