...
{{-- Maintenance Toggle --}}
<div class="mb-6">
    <div class="bg-white rounded-xl shadow-sm border {{ $maintenanceActive ? 'border-amber-300' : 'border-gray-100' }} p-5">
        <div class="flex items-center justify-between gap-4">
            <div class="flex items-center gap-3">
                <div class="w-10 h-10 rounded-xl flex items-center justify-center shrink-0
                            {{ $maintenanceActive ? 'bg-amber-100' : 'bg-gray-100' }}">
                    <svg class="w-5 h-5 {{ $maintenanceActive ? 'text-amber-600' : 'text-gray-400' }}"
        ...
        <div class="mt-3 pt-3 border-t border-amber-200 flex items-center gap-2">
            ...
            <p class="text-xs text-amber-700">
                ...
                Admin, Support, CSIRT, dan DPO tetap dapat login dan bekerja normal.
            </p>
        </div>
        @endif
    </div>
